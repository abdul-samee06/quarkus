# quarkus-login-with-token-authentication Project
...
You can then execute your native executable with: `./target/quarkus-login-with-token-authentication-1.0.0-SNAPSHOT-runner`
...
quarkus-login-with-token-authentication
